...
On a cold winter morning, a lonely seal woke from his slumber. He opened his phone and stumbled upon an article - "NexusMods will no longer allow mod authors to remove their mods from the platform". 'Oh no!', he thought to himself, whatever will I do? Later that day, after the seal had some time to think, he decided to remove his mods from the platform before it was too late, and instead opted to host his mods on the lovely website of GitHub. Over the next few days, the seal told his friends about what was happening, most of them agreed that they too were going to move their mods off the platform. Yet some of the seals friends simply didn't care, and some of them made money from Nexus which was enough of a reason for them to stick around. Of course not everyone can be on the same page about everything, so our seal friend simply respected the others decisions.  
...
<strong>QModManager is no longer in-use, mods need to transition from `QMods` to `BepInEx` mods, so far around 70-80 already have made the transition. All of those mods are functional in 2.0, but are extremely likely to cause issues if used with the Legacy branch.</strong>
 1. Download the [Subnautica BepInEx Pack](https://github.com/toebeann/BepInEx.Subnautica/releases/download/v5.4.21-payload.1.1.0/BepInEx_x64_5.4.21.0.zip), and optionally, but recommended, [BepInEx Tweaks](https://www.nexusmods.com/subnautica/mods/1104?tab=description), and [Configuration Manager](https://www.nexusmods.com/subnautica/mods/1112).
